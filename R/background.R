bkgrnd <- fluidRow(
  ...
  column(10,
    ...
    tagList(
      ...
      tags$p("The NE and SE Beta SDAMs are based on indicators measured in the field, plus two spatial variables generated using this website. The indicators are:")),
      tags$ul(
        tags$li(
          HTML(
