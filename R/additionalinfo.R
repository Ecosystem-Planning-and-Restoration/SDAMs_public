addinfo <- fluidRow(
  column(10,
         tagList(
           ...
           tags$p("Resources Desktop Reconnaissance:"),
           tags$ul(
               tags$li(tags$p(HTML(
                   "<a href =\"https://evwhs.digitalglobe.com/\">
                 DigitalGlobe
              </a>"))),
               tags$li(tags$p(HTML(
               ...
               tags$li(tags$p(HTML(
                   "<a href =\"https://streamstats.usgs.gov/ss/\">
                 StreamStats
              </a>"))),
               tags$li(tags$p(HTML(
                   "<a href =\"https://qpublic.schneidercorp.com/\">
                 Qpublic
              </a>"))),
               tags$li(tags$p(HTML(
                   "<a href =\"https://www.historicaerials.com/viewer\">
                 Historical Aerials
              </a>"))),
               tags$li(tags$p(HTML("State natural resource web pages (e.g. for
                   <a href =\"https://www.depgis.state.pa.us/emappa/\">
                 Pennsylvania)
              </a>"))),
