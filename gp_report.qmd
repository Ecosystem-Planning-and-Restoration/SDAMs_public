...
\textbf{\large{Mean bankfull channel width (m):}} `r params$bankwidth`
...
Aquatic macroinvertebrates: `r if (!is.null(params$aqua_inv)) {params$aqua_inv}`
...
Presence/absence of upland rooted plants in streambed: `r if (!is.null(params$upland_rooted)){params$upland_rooted}`
...
Presence of sediment on plants or debris: `r if (!is.null(params$sediment)){params$sediment}`
