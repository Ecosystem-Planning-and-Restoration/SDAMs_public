  ...
  observeEvent(c(input$reg_button, region_class()),{
   ...
   # })
    ...
    # })
      ...
      #       output$report <- generate_report(region_class())

      #     } else if (!is.atomic(region_class())){

      #       output$report <- generate_report(region_class()$region)
    ...
    #           params <- if (is.atomic(region_class())){

    #               generate_params(region_class())

    #             } else if (!is.atomic(region_class())){

    #               generate_params(region_class()$region)
