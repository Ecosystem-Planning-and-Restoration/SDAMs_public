...
Total abundance of Ephemeroptera, Plecoptera, and Trichoptera: `r if (!is.null(params$aqua_inv)) {params$aqua_inv}`

Total abundance of Indicator Species Analysis-based perennial indicator taxa observed in the reach: `r if (!is.null(params$eph_isa)) {params$eph_isa}`
